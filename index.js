...
// Import the csv-writer library
const createCsvWriter = require('csv-writer').createObjectCsvWriter;

// Import the csvWriter module
const { writeUsersToCsv } = require('./csvWriter');
...
app.get('/users', (req, res) => {
  res.json(usersData);
  // res.json(writeUsersToCsv(usersData))
});
...
//         user.location.city.includes(term) ||
//         user.location.country.includes(term) ||
//         user.gender.includes(term) ||
//         user.address.includes(term)
//     );
